...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_ldk_node_32c1_rustbuffer_alloc(size, status).also {
                if (it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_ldk_node_32c1_rustbuffer_free(buf, status)
        }
    }
...
internal interface _UniFFILib : Library {
    ...
    fun ffi_ldk_node_32c1_Builder_object_free(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): Unit

    fun ldk_node_32c1_Builder_new(
        _uniffi_out_err: RustCallStatus,
    ): Pointer

    fun ldk_node_32c1_Builder_from_config(
        `config`: RustBuffer.ByValue,
        _uniffi_out_err: RustCallStatus,
    ): Pointer

    fun ldk_node_32c1_Builder_build(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): Pointer

    fun ffi_ldk_node_32c1_Node_object_free(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): Unit

    fun ldk_node_32c1_Node_start(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): Unit

    fun ldk_node_32c1_Node_stop(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): Unit

    fun ldk_node_32c1_Node_sync_wallets(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): Unit

    fun ldk_node_32c1_Node_next_event(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): RustBuffer.ByValue

    fun ldk_node_32c1_Node_event_handled(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): Unit

    fun ldk_node_32c1_Node_node_id(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): RustBuffer.ByValue

    fun ldk_node_32c1_Node_new_funding_address(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): RustBuffer.ByValue

    fun ldk_node_32c1_Node_spendable_onchain_balance_sats(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): Long

    fun ldk_node_32c1_Node_total_onchain_balance_sats(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus,
    ): Long

    fun ldk_node_32c1_Node_connect_open_channel(
        `ptr`: Pointer,
        `nodePubkeyAndAddress`: RustBuffer.ByValue,
        `channelAmountSats`: Long,
        `announceChannel`: Byte,
        _uniffi_out_err: RustCallStatus,
    ): Unit

    fun ldk_node_32c1_Node_close_channel(
        `ptr`: Pointer,
    ...
    fun ldk_node_32c1_Node_send_payment(
        `ptr`: Pointer,
        `invoice`: RustBuffer.ByValue,
        _uniffi_out_err: RustCallStatus,
    ): RustBuffer.ByValue

    fun ldk_node_32c1_Node_send_spontaneous_payment(
        `ptr`: Pointer,
        `amountMsat`: Long,
    ...
    fun ldk_node_32c1_Node_receive_payment(
        `ptr`: Pointer,
    ...
    fun ffi_ldk_node_32c1_rustbuffer_alloc(
        `size`: Int,
        _uniffi_out_err: RustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_ldk_node_32c1_rustbuffer_from_bytes(
        `bytes`: ForeignBytes.ByValue,
        _uniffi_out_err: RustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_ldk_node_32c1_rustbuffer_free(
        `buf`: RustBuffer.ByValue,
        _uniffi_out_err: RustCallStatus,
    ): Unit

    fun ffi_ldk_node_32c1_rustbuffer_reserve(
        `buf`: RustBuffer.ByValue,
        `additional`: Int,
        _uniffi_out_err: RustCallStatus,
    ): RustBuffer.ByValue
...
class Builder(
    ...
    constructor() :
        this(
            rustCall() { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Builder_new(_status)
            },
        )
    ...
    protected override fun freeRustArcPtr() {
        rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_ldk_node_32c1_Builder_object_free(this.pointer, status)
        }
    }
    ...
    override fun `build`(): Node =
        callWithPointer {
            rustCall() { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Builder_build(it, _status)
            }
        }.let {
    ...
    companion object {
        fun `fromConfig`(`config`: Config): Builder =
            Builder(
                rustCall() { _status ->
                    _UniFFILib.INSTANCE.ldk_node_32c1_Builder_from_config(FfiConverterTypeConfig.lower(`config`), _status)
                },
            )
    }
}
...
class Node(
    ...
    protected override fun freeRustArcPtr() {
        rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_ldk_node_32c1_Node_object_free(this.pointer, status)
        }
    }
    ...
    override fun `start`() =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_start(it, _status)
            }
        }
    ...
    override fun `stop`() =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_stop(it, _status)
            }
        }
    ...
    override fun `syncWallets`() =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_sync_wallets(it, _status)
            }
        }
    ...
    override fun `nextEvent`(): Event =
        callWithPointer {
            rustCall() { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_next_event(it, _status)
            }
        }.let {
    ...
    override fun `eventHandled`() =
        callWithPointer {
            rustCall() { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_event_handled(it, _status)
            }
        }
    ...
    override fun `nodeId`(): PublicKey =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_node_id(it, _status)
            }
        }.let {
    ...
    @Throws(NodeException::class)
    override fun `newFundingAddress`(): Address =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_new_funding_address(it, _status)
            }
        }.let {
    ...
    @Throws(NodeException::class)
    override fun `spendableOnchainBalanceSats`(): ULong =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_spendable_onchain_balance_sats(it, _status)
            }
        }.let {
    ...
    @Throws(NodeException::class)
    override fun `totalOnchainBalanceSats`(): ULong =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_total_onchain_balance_sats(it, _status)
            }
        }.let {
            FfiConverterULong.lift(it)
        }
    ...
    @Throws(NodeException::class)
    override fun `connectOpenChannel`(`nodePubkeyAndAddress`: String, `channelAmountSats`: ULong, `announceChannel`: Boolean) =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_connect_open_channel(it, FfiConverterString.lower(`nodePubkeyAndAddress`), FfiConverterULong.lower(`channelAmountSats`), FfiConverterBoolean.lower(`announceChannel`), _status)
            }
        }

    @Throws(NodeException::class)
    override fun `closeChannel`(`channelId`: ChannelId, `counterpartyNodeId`: PublicKey) =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_close_channel(it, FfiConverterTypeChannelId.lower(`channelId`), FfiConverterTypePublicKey.lower(`counterpartyNodeId`), _status)
            }
        }

    @Throws(NodeException::class)
    override fun `sendPayment`(`invoice`: Invoice): PaymentHash =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_send_payment(it, FfiConverterTypeInvoice.lower(`invoice`), _status)
            }
        }.let {
    ...
    @Throws(NodeException::class)
    override fun `sendSpontaneousPayment`(`amountMsat`: ULong, `nodeId`: String): PaymentHash =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_send_spontaneous_payment(it, FfiConverterULong.lower(`amountMsat`), FfiConverterString.lower(`nodeId`), _status)
            }
        }.let {
            FfiConverterTypePaymentHash.lift(it)
        }
    ...
    @Throws(NodeException::class)
    override fun `receivePayment`(`amountMsat`: ULong?, `description`: String, `expirySecs`: UInt): Invoice =
        callWithPointer {
            rustCallWithError(NodeException) { _status ->
                _UniFFILib.INSTANCE.ldk_node_32c1_Node_receive_payment(it, FfiConverterOptionalULong.lower(`amountMsat`), FfiConverterString.lower(`description`), FfiConverterUInt.lower(`expirySecs`), _status)
            }
        }.let {
...
public object FfiConverterTypeConfig : FfiConverterRustBuffer<Config> {
    ...
    override fun allocationSize(value: Config) = (
        FfiConverterString.allocationSize(value.`storageDirPath`) +
            ...
            FfiConverterOptionalString.allocationSize(value.`listeningAddress`) +
    ...
    override fun write(value: Config, buf: ByteBuffer) {
        ...
        FfiConverterOptionalString.write(value.`listeningAddress`, buf)
...
sealed class NodeException(message: String) : Exception(message) {
    ...
    class NetworkInvalid(message: String) : NodeException(message)
...
public object FfiConverterTypeNodeError : FfiConverterRustBuffer<NodeException> {
    override fun read(buf: ByteBuffer): NodeException {
        return when (buf.getInt()) {
            ...
            12 -> NodeException.NetworkInvalid(FfiConverterString.read(buf))
            13 -> NodeException.RoutingFailed(FfiConverterString.read(buf))
            14 -> NodeException.PeerInfoParseFailed(FfiConverterString.read(buf))
            15 -> NodeException.ChannelCreationFailed(FfiConverterString.read(buf))
            16 -> NodeException.ChannelClosingFailed(FfiConverterString.read(buf))
            ...
            19 -> NodeException.WalletSigningFailed(FfiConverterString.read(buf))
            20 -> NodeException.TxSyncFailed(FfiConverterString.read(buf))
    ...
    override fun write(value: NodeException, buf: ByteBuffer) {
        when (value) {
            ...
            is NodeException.NetworkInvalid -> {
                buf.putInt(12)
                Unit
            }
